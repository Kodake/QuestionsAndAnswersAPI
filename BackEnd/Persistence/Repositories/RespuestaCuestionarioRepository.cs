...
namespace BackEnd.Persistence.Repositories
{
    public class RespuestaCuestionarioRepository : IRespuestaCuestionarioRepository
    {
        ...
        {
            return await _context.RespuestaCuestionario.Where(x => x.CuestionarioId == idCuestionario && x.Activo == 1 && x.Cuestionario.UsuarioId == idUsuario)
        ...
        {
            return await _context.RespuestaCuestionario.Where(x => x.Id == idCuestionario
        ...
        {
            return await _context.RespuestaCuestionarioDetalles.Where(x => x.RespuestaCuestionarioId == idRespuestaCuestionario)
